...
REGISTER_OBSERVATION(keyboard_velocity_commands)
{
    ...
    else if (key == "x") target_cmd = {0.0f, 0.0f, 0.0f};
    ...
    cmd[0] = step_towards(cmd[0], target_cmd[0], 0.01f);
    cmd[1] = step_towards(cmd[1], target_cmd[1], 0.01f);
    cmd[2] = step_towards(cmd[2], target_cmd[2], 0.015f);
